  ...
  return (
    <div className="py-16 bg-midnight">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-y-12 gap-x-8 justify-items-center mb-12">
          {data.slice(0, 5).map((diff, index) => (
            <motion.div
              key={index}
            ...
            >
              <div className="bg-yellow-400 p-5 sm:p-6 rounded-full shadow-md mb-4">
