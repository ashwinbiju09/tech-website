...
const Navigation = () => {
  ...
  return (
    <nav className="hidden md:block sticky top-16 lg:top-16 z-40 pt-4">
      <div className="max-w-3xl mx-auto bg-slate-100 rounded-lg shadow-md border border-slate-200">
